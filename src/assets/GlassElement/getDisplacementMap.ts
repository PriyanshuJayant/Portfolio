...
//   // const scaledDepth = Math.max(1, depth * scaleFactor);
...
/**
 * Creates the displacement map (used by feDisplacementMap).
 * Gradients respect radius scaling, so corners look natural.
 */
export const getDisplacementMap = ({
  height,
  width,
